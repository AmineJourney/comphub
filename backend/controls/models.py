...
class AppliedControl(TenantMixin, TimeStampedModel, SoftDeleteModel):
    ...
    # Owner/admin validation workflow
    ...
    validation_requested_by = models.ForeignKey(
        'core.User',
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=['company', 'validation_status'], name='applied_validation_idx'),
    ...
    def calculate_compliance_score(self):
        ...
        # Full compliance requires owner/admin validation.
        if self.validation_status == 'rejected':
            score = min(score, 25)
        elif self.validation_status != 'approved':
            score = min(score, 60)
